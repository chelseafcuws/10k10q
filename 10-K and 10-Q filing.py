...
df.rename(columns={'val': 'ValueNum','form':'FormCode', 'fy':'PeriodFY','fp':'PeriodFP','end':'reportDate'}, inplace=True)
...
df['StartDate'] = df.apply(calculate_date, axis=1)
